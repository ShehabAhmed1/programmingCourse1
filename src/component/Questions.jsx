...
const Questions = () => {
  ...
  const faqData = [
    ...
    {
      id: 2,
      question: "أنا أقل من 15 سنة، هل ممكن أشارك؟",
      answer:
        "الكورس مصمم للفئة العمرية 15 سنة فأكثر ولكن هناك اعداد لكورس  مناسب للفئة العمريه الاقل  وعند الاعلان عنه تقدر تشارك فيه .",
    },
    {
      id: 3,
