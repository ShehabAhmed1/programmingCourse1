  ...
  const requirements = [
    {
      ...
      text: "أن يكون عمر المشترك 8 سنة أو أكثر.",
    },
    {
      id: 2,
      icon: <FaBookOpen className="w-6 h-6 text-green-600" />,
      text: "مستوي جيد في القراءة والكتابة باللغة العربية ومستوي مقبول في اللغة الإنجليزية.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      text: "أن يمتلك الطالب رغبة حقيقية في تعلّم البرمجة، وأن يكون مستعدًا للدراسة والتجربه، نظرًا لأن البرمجة تحتاج إلى ممارسة منتظمة لتحقيق التقدم الفعلي.",
    },
  ];
